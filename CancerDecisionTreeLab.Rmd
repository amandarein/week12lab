...
training2 <- subset(training2, select=-c(Gender, ER.Status, HER2.Final.Status, Node.Coded, Metastasis, Metastasis.Coded))
test2 <- subset(test2, select=-c(Gender, ER.Status, HER2.Final.Status, Node.Coded, Metastasis, Metastasis.Coded))
