...
=======
>>>>>>> 3a3475c4c497587849b7036405dcc89e804404ca
...
##### CP Chart
The CP (complexity paramter) chart below helps us determine the optimal size of the tree. Based on our plot, the optimal size is 1.
```{r, message=FALSE, echo = FALSE, warning=FALSE}
...
=======
tree_predict2 = predict(tree_tumor, test, type= "class")
>>>>>>> 3a3475c4c497587849b7036405dcc89e804404ca
...
=======
multiclass.roc(test$Tumor, ifelse(tree_example_prob2[,'T1'] >= .05,0,1), plot=TRUE)
# multiclass.roc(test$Tumor, ifelse(tree_example_prob2[,'T2'] >= .17 ,0,1), plot=TRUE)
# multiclass.roc(test$Tumor, ifelse(tree_example_prob2[,'T3'] >= .49,0,1), plot=TRUE)
# multiclass.roc(test$Tumor, ifelse(tree_example_prob2[,'T4'] >= .38,0,1), plot=TRUE)
>>>>>>> 3a3475c4c497587849b7036405dcc89e804404ca
...
=======
training2 <- subset(training, select=-c(HER2.Final.Status, PR.Status, Node.Coded, AJCC.Stage, Converted.Stage, Survival.Data.Form, Vital.Status))
test2 <- subset(test, select=-c(HER2.Final.Status, Node.Coded, PR.Status, AJCC.Stage, Converted.Stage, Survival.Data.Form, Vital.Status))
>>>>>>> 3a3475c4c497587849b7036405dcc89e804404ca
