...
PR_mdl$finalModel
PR_predict = predict(PR_mdl$finalModel,test)
?predict


features <- training[,c(-2)]
target <- training$PR.Status

c_tree_1 <- C5.0(x=features,y=target, trials=1, winnow=FALSE, control=C5.0Control(earlyStopping=FALSE))
c_tree_1


c_tree_pred_1 <- predict(c_tree_1, test)

c_tree_pred_1
c_tree_pred_2
View(as_tibble(cancer_tree_pred))
